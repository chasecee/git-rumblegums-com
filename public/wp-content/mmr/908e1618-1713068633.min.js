...
/******************
MMR MERGED: /wp-content/themes/Flexible/bootstrap/js/bootstrap.min.js
***************/
...
/******************
MMR MERGED: /wp-content/themes/Flexible/js/jquery.viewportchecker.min.js
***************/
...
;jQuery(document).ready(function($){function scroll_animations(){var parent=$('.anim_parent');var children=$(parent).children();children.addClass('hider');$(parent).viewportChecker({classToAdd:'visible',offset:100,callbackFunction:function(elem){var elements=elem.find(children),i=0;interval=setInterval(function(){var time=i/4;elements.eq(i++).addClass('visible animated fadeIn').css('-webkit-animation-delay',time+'s').css('-moz-animation-delay',time+'s').css('-ms-animation-delay',time+'s').css('-o-animation-delay',time+'s').css('animation-delay',time+'s');if(i==elements.length){clearInterval(interval)}},0)}});$('.anim').addClass("hider").viewportChecker({classToAdd:'visible animated fadeIn',offset:100});$('.anim_left').addClass("hider").viewportChecker({classToAdd:'visible animated fadeInLeft',offset:100});$('.anim_right').addClass("hider").viewportChecker({classToAdd:'visible animated fadeInRight',offset:100});$('.anim_up').addClass("hider").viewportChecker({classToAdd:'visible animated fadeInUp',offset:100})}
var isMobile=window.matchMedia("only screen and (max-width: 767px)");if(isMobile.matches){$('.anim_parent').children().removeClass("hider");$('.anim,.anim_left,.anim_right,.anim_up').removeClass("hider")}else{scroll_animations()}
var video=document.getElementById('videoID');var video=$('#videoID').get(0);var video=$('#videoID')[0];var video=$('#videoID');$('.btnPlay').on('click',function(){if(video[0].paused){video[0].play();$(this).html('<i class="fa fa-play"></i>')}else{video[0].pause();$(this).html('<i class="fa fa-pause"></i>')}
return!1});$('.muted').click(function(){video[0].muted=!video[0].muted;if(!video[0].muted){$(this).html('<i class="fa fa-volume-off"></i>')}else{$(this).html('<i class="fa fa-volume-up"></i>')}
return!1});$('#pastshows').click(function(){$('#past_toggler').slideToggle()});function past_shows(){var numItems=$('.past').children('#show_wrap').length;$('#pastshows span').text(numItems)}
past_shows()});

/******************
MMR MERGED: /wp-content/plugins/new-royalslider/lib/royalslider/jquery.royalslider.min.js
***************/
  ...
  v.prototype = {
    ...
    setItemHtml: function (b, e) {
      var d = this,
        ...
        m = function (a) {
          d.st.usePreloader &&
            ((a = b.holder.find(".rsPreloader")), a.length && a.remove());
        };
      b.isLoaded
        ? f()
        : e
    ...
    _onDragStart: function (b, e) {
      ...
      if (l(b.target).closest(".rsNoDrag", d._currHolder).length)
    ...
    updateSliderSize: function (b) {
      if (this.slider) {
        ...
        if (b || a != this.width || c != this.height) {
          ...
          this._slideSize =
            (this._slidesHorizontal ? this._wrapWidth : this._wrapHeight) +
    ...
    _bindPassiveEvent: function (b, e, d, a) {
      ...
      for (var c = 0; c < e.length; c++)
        e[c] &&
          2 < e[c].length &&
          b.addEventListener(e[c], d, a ? this._passiveParam : !1);
    },
    _unbindPassiveEvent: function (b, e, d, a) {
      ...
      for (var c = 0; c < e.length; c++)
        e[c] &&
          2 < e[c].length &&
          b.removeEventListener(e[c], d, a ? this._passiveParam : !1);
    },
...
(function (g) {
  g.extend(g.rsProto, {
    ...
    _createThumbs: function () {
      ...
      f = {};
      b.paddingTop &&
        (f[a._thumbsHorizontal ? "paddingTop" : "paddingLeft"] = b.paddingTop);
      b.paddingBottom &&
    ...
    _setupAutoPlay: function () {
      ...
      a.st.autoPlay.pauseOnHover &&
        ...
        a.slider.hover(
          function () {
            a._autoPlayEnabled &&
              ((a._autoPlayPaused = !1), a._pause(), (a._pausedByHover = !0));
          },
          function () {
  ...
  f.extend(f.rsProto, {
    _initVideo: function () {
      ...
      a._videoDefaults = {
        ...
        disableCSS3inFF: !0,
        youTubeCode:
          '<iframe loading="lazy"  src="https://www.youtube.com/embed/%id%?rel=0&autoplay=1&showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>',
        vimeoCode:
          '<iframe loading="lazy"  src="https://player.vimeo.com/video/%id%?byline=0&portrait=0&autoplay=1" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>',
      };
    ...
    playVideo: function () {
      ...
      if (!a._isVideoPlaying) {
        ...
        if (d.match(/youtu\.be/i) || d.match(/youtube\.com/i)) {
          ...
          void 0 !== c &&
            (a._videoFrameHolder = a.st.video.youTubeCode.replace("%id%", c));
        } else
          d.match(/vimeo\.com/i) &&
            ((e = /(www\.)?vimeo.com\/(\d+)($|\/)/),
            (e = d.match(e)) && (c = e[2]),
            void 0 !== c &&
              (a._videoFrameHolder = a.st.video.vimeoCode.replace("%id%", c)));
      ...
      if (a.st.deeplinking.enabled) {
        var e = a.st.deeplinking.change,
          ...
          g = function () {
            ...
            return a &&
              0 < a.indexOf(c) &&
              ((a = parseInt(a.substring(k.length), 10)), 0 <= a)
              ? a - 1
              : -1;
          },
          l = g();
      ...
      (function () {
        ...
        e.start = function () {
          a ||
            ...
            (a = b('<iframe loading="lazy"  tabindex="-1" title="empty"/>')
              .hide()
              .one("load", function () {
                c || m(d());
                l();
